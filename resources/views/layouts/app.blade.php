            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                        <li class="nav-item">
                            <a href="{{ route('companies.index') }}" class="nav-link">Empresas</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('operators.index') }}" class="nav-link">Operadores</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('invoces.index') }}" class="nav-link">Ventas</a>
                        </li>
